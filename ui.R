                      ...
                      box( status = "warning", width = 4,
                           tabBox(
                             ...
                             tabPanel("Upload",
                                      ...
                                      fluidRow(
                                        ...
                                        column(2,
                                               selectInput("quote_venn", "Quote:",
                                                           ...
                                                           selected = "\"")),
                                        column(6,
                                               selectInput("sep_venn", "Delimiter(Tab -> .tsv|, -> .csv):",
                                                           list("Tab" = "\t",
                                                                "," = ",",
                                                                "Space" = " ",
                                                                ";" = ";"),
                                      ...
                                      fluidRow(
                                        column(4,
                                               checkboxInput('dedup_venn', label = 'Deduplicate', FALSE)),
                                        column(6,
                                               selectInput("sep_row_venn", "Split.By(1 Peak >1 genes promoters):",
                                                           list("Tab" = "\t",
                                                                "," = ",",
                                                                "Space" = " ",
                                                                ";" = ";",
                                      ...
                                      tags$div(style = 'overflow-x: scroll',excelOutput("hot_venn")),
                                      br(),
                                      ...
                                      HTML("<a href='Peak.merge.anno.csv'> <i class='fa fa-download'> </i> Binary for Peak</a>")
                             ),
                             tabPanel("Settings",
                                      #add content
                       ...
                       box(
                         ...
                         tabBox(
                           ...
                           tabPanel("Upload",
                                    ...
                                    fluidRow(
                                      ...
                                      column(2,
                                             selectInput("quote_upset", "Quote:",
                                                         ...
                                                         selected = "\"")),
                                      column(6,
                                             selectInput("sep_upset", "Delimiter(Tab -> .tsv|, -> .csv):",
                                                         list("Tab" = "\t",
                                                              "," = ",",
                                                              "Space" = " ",
                                                              ";" = ";"),
                                    ...
                                    fluidRow(
                                      column(4,
                                             checkboxInput('dedup_upset', label = 'Deduplicate', FALSE)),
                                      column(6,
                                             selectInput("sep_row_upset", "Split.By(1 Peak >1 genes promoters):",
                                                         list("Tab" = "\t",
                                                              "," = ",",
                                                              "Space" = " ",
                                                              ";" = ";",
                                    ...
                                    tags$div(style = 'overflow-x: scroll',excelOutput("hot_upset")),
                                    br(),
